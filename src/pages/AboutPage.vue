    ...
    <q-card class="std-card">
      <div class="title-row q-pa-md q-gutter-sm">
        <div>
          ...
          <div style="margin-top: 8px;">This Free and OpenSource Software (FOSS) is developed and maintained by Sayem
            Shafayet.</div>


          <div style="margin-top: 8px;">Source Code: <a href="https://github.com/iShafayet/cash-keeper-client"
              target="_blank">Under
              GPL-3.0 license on GitHub</a>.</div>
          <div style="margin-top: 8px;">2023 to {{ getCurrentYear() }} © <a href="https://ishafayet.me"
              target="_blank">Sayem
              Shafayet</a>.
          </div>
